...
<html>
    ...
    <body>
        ...
        <br/>
        <div class="container">
            <center><h2 class="teal-text text-lighten-2">Mantenimiento de gafetes</h2></center>
            <br/>
            <center><h3 class="teal-text text-lighten-2">${mensAlert}</h3></center>
            <br/>
            <div class="row">
                <form name="DatosForm" method="POST" action="GafeServ" class="col s12">                    
                ...
                <form name="TablaForm" method="POST" action="GafeServ" class="col s12">
                    ...
                    <table border="1" class="striped">
                        ...
                        <tbody>
                            <c:forEach items="${beanTipoGafeCtrl.consTodo()}" var="fila">
                                <tr>
                                    <td><c:out value="${fila.nombTipoGafe}"></c:out></td>
                                    <td><p><input id="${fila.codiTipoGafe}" type="radio" name="codiGafeRadi" value="${fila.codiTipoGafe}"/><label for="${fila.codiTipoGafe}"></label></p></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
